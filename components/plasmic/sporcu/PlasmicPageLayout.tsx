...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: GMdLGo3RR1l-/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <AntdMenu
            className={classNames("__wab_instance", sty.menu__fXc1R)}
            multiple={false}
          >
            <AntdMenuItem
              className={classNames("__wab_instance", sty.menuItem__lnem9)}
              key={"menuItemKey"}
            >
              <div
            ...
            <AntdMenuItem
              className={classNames("__wab_instance", sty.menuItem___8Ff4R)}
              key={"menuItemKey2"}
            >
              <div
                data-plasmic-name={"hesapAyarlari"}
                data-plasmic-override={overrides.hesapAyarlari}
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
                  sty.hesapAyarlari
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Card
                className={classNames("__wab_instance", sty.card___2Zz6N)}
                title={
                  <div
                    className={classNames(
                      projectcss.all,
...
const PlasmicDescendants = {
  root: ["root", "columns", "menu", "text", "hesapAyarlari", "content"],
  columns: ["columns", "menu", "text", "hesapAyarlari", "content"],
  menu: ["menu", "text", "hesapAyarlari"],
  text: ["text"],
  hesapAyarlari: ["hesapAyarlari"],
  content: ["content"]
} as const;
...
export const PlasmicPageLayout = Object.assign(
  ...
  makeNodeComponent("root"),
  {
    ...
    hesapAyarlari: makeNodeComponent("hesapAyarlari"),
