...
import sty from "./PlasmicButton.module.css"; // plasmic-import: Wb6MvWEjKrS6/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 8BR63HtdN-P-/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: LMXQp7pubRu7/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__ifEja)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon2Icon
                className={classNames(projectcss.all, sty.svg__wo1J)}
                role={"img"}
              />
            ),
